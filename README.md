...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 66c7bb22-3bf5-4fef-b48e-fbae8c70924e
```

> `66c7bb22-3bf5-4fef-b48e-fbae8c70924e` is the password of the certificate, you can change it to any password you want.
